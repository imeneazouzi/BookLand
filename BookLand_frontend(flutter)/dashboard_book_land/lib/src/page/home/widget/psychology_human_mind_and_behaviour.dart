...
class PsychologyBook extends StatelessWidget {
  final psychologyList = Book.generatedPsychologyBook();
  PsychologyBook({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Column(
      children: [
        const CategoryTitle('Psychology, Human Mind and Behaviour'),
        SizedBox(
          height: 250,
          child: ListView.separated(
              ...
              itemCount: psychologyList.length),
        )
      ],
    );
  }
