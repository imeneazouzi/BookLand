...
*/
  static List<CDM> cdms = [
    ...
    CDM(Icons.subscriptions, "Category", ["Psychology human mind and behaviour ", "Aircraft cars mechanics and physics", "Sports athletics and motorsports"]),
    CDM(Icons.pie_chart, "Reviews and Ratings", []),
    CDM(Icons.pie_chart, "Best rated", []),
